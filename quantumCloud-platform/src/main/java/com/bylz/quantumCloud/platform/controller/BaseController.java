...
abstract public class BaseController {
    ...
    {
        return messageSource.getMessage(message, objs, (Locale) (getRequest().getSession().getAttribute(SessionLocaleResolver.LOCALE_SESSION_ATTRIBUTE_NAME)!=null?getRequest().getSession().getAttribute(SessionLocaleResolver.LOCALE_SESSION_ATTRIBUTE_NAME):new Locale("zh", "CN")));
    }

    public String getMessageUs(String message, Object... objs)
    {
        return messageSource.getMessage(message, objs, (Locale) (getRequest().getSession().getAttribute(SessionLocaleResolver.LOCALE_SESSION_ATTRIBUTE_NAME)!=null?getRequest().getSession().getAttribute(SessionLocaleResolver.LOCALE_SESSION_ATTRIBUTE_NAME):new Locale("en", "US")));
    }
