...
public class  SensitiveWordUtil {
    ...
    public SensitiveWordUtil(Set<String> set) {
        init(set);
    }
...
//        Set<String> sensitiveWordSet = readFile();
...
//        //初始化敏感词库
//        TestSensitiveWord.init(sensitiveWordSet);
//
//        System.out.println("敏感词的数量：" + TestSensitiveWord.sensitiveWordMap.size());
//        String string = "习近平伤感情怀也许只局限于饲养基地 荧幕中的情节。"
...
//
//        //是否含有关键字
//        boolean result = TestSensitiveWord.contains(string);
//        System.out.println(result);
//        result = TestSensitiveWord.contains(string, TestSensitiveWord.MinMatchTYpe);
//        System.out.println(result);
//
//        //获取语句中的敏感词
//        Set<String> set = TestSensitiveWord.getSensitiveWord(string);
//        System.out.println("语句中包含敏感词的个数为：" + set.size() + "。包含：" + set);
//        set = TestSensitiveWord.getSensitiveWord(string, TestSensitiveWord.MinMatchTYpe);
//        System.out.println("语句中包含敏感词的个数为：" + set.size() + "。包含：" + set);
//
//        //替换语句中的敏感词
//        String filterStr = TestSensitiveWord.replaceSensitiveWord(string, '*');
//        System.out.println(filterStr);
//        filterStr = TestSensitiveWord.replaceSensitiveWord(string, '*', TestSensitiveWord.MinMatchTYpe);
//        System.out.println(filterStr);
//
//        String filterStr2 = TestSensitiveWord.replaceSensitiveWord(string, "[*敏感词*]");
//        System.out.println(filterStr2);
//        filterStr2 = TestSensitiveWord.replaceSensitiveWord(string, "[*敏感词*]", TestSensitiveWord.MinMatchTYpe);
//        System.out.println(filterStr2);
//    }
//
//    public static Set<String> readFile() throws IOException {
//        File file = new File("C:\\Users\\QuantumBYLZ061901\\Desktop\\aaa.txt");
//        InputStreamReader fileReader = new InputStreamReader(new FileInputStream(file),"GBK");
