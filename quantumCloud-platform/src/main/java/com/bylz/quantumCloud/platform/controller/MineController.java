...
import com.bylz.quantumCloud.platform.util.RegExpValidatorUtils;
...
public class MineController extends BaseController {
	 ...
	 * @JT
	 */
	@RequestMapping(value = "/redPacket.html")
	public String redPacket(ModelMap model) {
		QcodeUser qcodeUser = AppContextHolder.getCurrentUser();
		model.put("ticket",  WeChatUtils.getQRCodeTicket(qcodeUser.getId()));
		return "redPacket";
	}
