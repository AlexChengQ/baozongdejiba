...
<@main.header>
    ...
    <script>
        isIndex=1;
        if (window.navigator.userAgent.indexOf("MSIE 7.0")>=1||window.navigator.userAgent.indexOf("MSIE 8.0")>=1){                    //如果浏览器为IE7
            alert('为了更好的体验，请使用IE9及更高版本浏览器访问该页面')
        }
    </script>
    </#escape>
</@main.header>
            ...
            <div class="NewBox" id="NewBox">
                ...
                <div class="NewModule">
                        ...
                        <div class="modLeft_l clearfix" style=";height: 395px;overflow:hidden">
                            <ul>
                                <#list 0..((qcodeProject.qubitNum)?default(6)-1) as i>
                                    <li><div class="modleft_ll">q[${i}]</div><div class="modleft_lr">|<span>0></span></div></li>
                                </#list>
                            </ul>
                        </div>
                    ...
                    <div class="NewModuleRight">
                        <div class="modRight_top">
                            <ul><#list 1..100 as n><li>${n}</li></#list></ul>
                        </div>
                        <div class="modRight_center" id="modRight_center"></div>
                        <div class="simulate_box">
                            <div class="pointTag pointTag1"><img data-src="${base}/assets/images/guideTag.png" alt=""></div>
                            <#--添加单比特门-->
                            <div class="pointTag pointTag2"><img data-src="${base}/assets/images/guideTag.png" alt=""></div>
                            <#--添加单比特门成功-->
                            <div class="pointTag pointTag3">
                                <img data-src="${base}/assets/images/New_H.png" alt="">
                            </div>
                        <#--添加多比特门-->
                            <div class="pointTag pointTag4"><img data-src="${base}/assets/images/guideTag.png" alt=""></div>
                            <div class="pointTag pointTag5"><img data-src="${base}/assets/images/guideTag1.png" alt=""></div>
                            <div class="pointTag pointTag6"><img data-src="${base}/assets/images/guideTag2.png" alt=""></div>
                            <#--添加测量门-->
                            <div class="pointTag pointTag7"><img data-src="${base}/assets/images/guideTag.png" alt=""></div>
                            <#--添加测量门2-->
                            <div class="pointTag pointTag8"><img data-src="${base}/assets/images/guideTag.png" alt=""></div>
                ...
                <div class="NewConsole">
                    ...
                    <div class="NewConBtnBox">
                        <button class="downloadSvg" style="display: none"><i></i><span>saveSvg</button>
                        ...
                        <button class="New_run" onclick="CloudCLD.running();"><i></i><span><@spring.message code="run" /></span></button>
                        <#elseif !USER_INFO??>
                        <button class="New_run" onclick="CloudCLD.visitorRunning();"><i></i><span><@spring.message code="run" /></span></button>
                        <#else >
                        <button class="New_run" onclick="CloudCLD.running();"><i></i><span><@spring.message code="run" /></span></button>
                        </#if>
                    ...
                    <div class="titleBeWorth">
                        <#if qcodeProject.analogType?? && qcodeProject.analogType==2>
                            <select class="form-control" name="property" id="property">
                                ...
                                <option value="3*pi/4">3*pi/4</option>
                            </select>
                        <#else>
                        ...
                        <div class="sort_con_list">
                            <ul>
                                ...
                                <li type="ZPi2" id="dragZPi2" imgName="New_Zpi2.png">
                                    ...
                                    <p class="sort_tip_hw">$$Z= \begin{bmatrix}exp(-i\pi/4) & 0 \\ 0 & exp(i\pi/4) \end{bmatrix}$$</p>
                                </li>
...
<g>
	...
	<g>
        ...
        <#if qcodeProject.analogType?? && qcodeProject.analogType!=2>
            ...
            <div id="dragImgBox">
                <img id="dragImgTea" src="${base}/assets/images/New_H.png" alt="">
            </div>
        </div>
        ...
        <div class="MyProBox clearfix">
            <div class="ProDetails newProject" style="display: none">
                <a href="javascript:;" onclick="CloudCLD.openAdd();">
                    <img data-src="${base}/assets/images/newProject.png" alt="">
                    <p>新建项目</p>
                </a>
            </div>
                <#if (qcodeProject.id?? && !(qcodeProject.id=257||qcodeProject.id=258))&&(qcodeProject.taskTypeId?? && qcodeProject.taskTypeId!=3)>
                        ...
                        <div class="there" id="vectoring3" style="display:none;">
                            <form class="form-horizontal">
                                <div class="form-group" style="margin-bottom:28px">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" name="analogType" id="analogType" oninput="CloudCLD.checkQubitNum(this)" onpropertychange="CloudCLD.checkQubitNum(this)">
                                ...
                                <div class="form-group" style="margin-bottom:28px">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="qubitNum"
                                               oninput="CloudCLD.checkQubitNum(this)" onpropertychange="CloudCLD.checkQubitNum(this)"
                            ...
                            <div class="f-jiaocheng">
                                ...
                                <ul>
                                    <li class="bbr" semi="1" style="height:200px;">
                                        <#--<img data-src="${base}/assets/images/p1.png" width="100%"/>-->
                                    ...
                                    <li semi="2" style="height:200px;">
                                        <#--<img data-src="${base}/assets/images/p2.png" width="100%"/>-->
                                    ...
                                    <li semi="3" style="height:200px;">
                                        <#--<img data-src="${base}/assets/images/p3.png" width="100%"/>-->
                                    ...
                                    <li semi="4" style="height:200px;">
                                        <#--<img data-src="${base}/assets/images/p4.png" width="100%"/>-->
            ...
            <div class="modal-content vectoring22">
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <#if qcodeProject.analogType?? && (qcodeProject.analogType?string=="0" || qcodeProject.analogType?string=="2")>
                            <div class="form-group">
    ...
    <div class="guideContent">
        <div class="guideId1">
            <div class="guide_con">
                <div class="pointTo"><img data-src="${base}/assets/images/pointTo.png" alt="点击"></div>
        ...
        <div class="guideId2">
            <div class="guide_con">
                <div class="pointTo"><img data-src="${base}/assets/images/pointToRight.png" alt="点击"></div>
        ...
        <div class="guideId7">
            <div class="guide_con">
                <div class="pointTo"><img data-src="${base}/assets/images/pointToLeft.png" alt="点击"></div>
...
<script type="text/javascript" src="${base}/assets/build/js/main.min.js?1.3"></script>
<#--<script type="text/javascript" src="${base}/assets/js/qcode.js?1.1"></script>-->
<#--<script type="text/javascript" src="${base}/assets/js/code2Trans.js?1.1"></script>-->
<#--<script type="text/javascript" src="${base}/assets/js/dragTrans.js?1.1"></script>-->
...
<link rel="stylesheet" data-href="${base}/assets/codemirror/lib/codemirror.css">
<link rel="stylesheet" data-href="${base}/assets/codemirror/addon/fold/foldgutter.css">
<link rel="stylesheet" data-href="${base}/assets/codemirror/addon/dialog/dialog.css">
<link rel="stylesheet" data-href="${base}/assets/codemirror/theme/monokai.css">
...
<script src="${base}/assets/js/saveSvgAsPng.js"></script>
<#--edit end-->
<script>
//    界面滚动条
    ...
    $(".downloadSvg").on("click",function () {
        saveSvgAsPng(document.getElementById("svgBoard"), "svgPrintscreen.png");
    })
      <#if USER_INFO??>
           if(window.navigator.userAgent.indexOf("MSIE")>=1){
               ...
               if ((theUA.match(/msie\s\d+/) && theUA.match(/msie\s\d+/)[0]) || (theUA.match(/trident\s?\d+/) && theUA.match(/trident\s?\d+/)[0])) {
                   ...
                   if (ieVersion >= 9) {
                       $(".downloadSvg").removeAttr("style")
                   };
               }
           }else if(window.navigator.appName=="Netscape"&&window.navigator.vendor==''){
...
<script data-type="text/javascript" src="${base}/assets/js/echarts/macarons.js"></script>