...
import com.bylz.quantumCloud.education.util.weibo4j.http.BASE64Encoder;
import com.bylz.quantumCloud.education.util.weibo4j.model.PostParameter;
...
public class Oauth extends Weibo {
		...
		return new AccessToken(client.post(
				...
				new PostParameter[] {
						...
						new PostParameter("redirect_uri", WeiboConfig
								.getValue("weibo_redirect_URI")) }, false, null));
	}
	...
	public String authorize(String response_type) throws WeiboException {
		return WeiboConfig.getValue("authorizeURL").trim() + "?client_id="
				...
				+ WeiboConfig.getValue("weibo_redirect_URI").trim()
	...
	public User showUserById(String uid,String access_token) throws WeiboException {
