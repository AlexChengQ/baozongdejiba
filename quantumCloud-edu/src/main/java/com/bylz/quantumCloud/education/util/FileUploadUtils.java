...
import com.bylz.quantumCloud.education.util.DateUtils.DateStyle;
...
public class FileUploadUtils {
	 ...
	 * 普通方式上传图片
	 */
	public static String uploadPic(QcodeUser userInfor,MultipartFile file) {
	...
	public static String uploadPic(MultipartFile file,String name) {
		...
		if(file != null && !file.isEmpty()) {
			...
			String filePath = AppContextHolder.getFileSavePath()+name;
