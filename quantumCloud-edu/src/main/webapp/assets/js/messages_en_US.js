var messages = 
{
	...
	must_be_operated:'You have\'t operated it yet',
    Confirm_tab_tip0:'Are you sure you want to switch to "graphic design" mode? The comments in the code will disappear.',
    Confirm_tab_tip1:'Are you sure you want to switch to "quantum language" mode? The arrangement of ICONS in the design may change.',
	...
	number_of_qubits_1_30:'Quantum bit number <br/> <span>(above 1-32,20 requires level2 or requires test permissions permissions)</span>',
	number_of_classical_registers_1_255:'Number of classic registers <br/> <span>(1-255, used to hold measurements)</span>',
	...
	measure_is_only_in_line:'Only one measuring gate is allowed on each of the qubit lines，in lines ',
    ...
    user_application_is_submit:'Personal information is changed successfully',
	init_waiting:'In initialization, please later',

    //page_apply
    phone_not_null:'The phone can\'t be empty.',
    phone_is_proper:'The phone incorrectly formatting',
    email_not_null:'Mailbox can\'t be empty.',
    email_is_proper:'Mailbox incorrectly formatting',
    vmType_not_null:'Please select the what virtual machine.',
    purpose_not_null:'The purpose of use can\'t be empty.',
    apply_is_submit:'Application has been submitted.',
    checkbox_is:'Please read and agree with the user application terms',
};
