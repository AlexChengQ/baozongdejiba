        ...
        <div class="modal-dialog" role="document" style="margin-top: 150px;">
            <div class="modal-content" style="box-shadow: 0 1px 4px rgb(217, 217, 217);-webkit-box-shadow: 0 1px 4px rgb(217, 217, 217);">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="_hmt.push(['_trackEvent','register']);register();" style="float: left;margin-left: 148px;width: 100px;text-align: center;"><@spring.message code="sign_up" /></button>
