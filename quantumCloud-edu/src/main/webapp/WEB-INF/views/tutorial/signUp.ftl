                            ...
                            <div class="signUp_form">
                                ...
                                <div class="professional_infor">
                                    ...
                                    <div class="professional_box">
                                        <label><span class="asterisk">从事行业</span></label>
...
<@main.footer>
    <script>
                ...
                success:function(data) {
                    if(data.success) {
                        layer.msg("报名成功",{icon: 1,time: 3000},function () {
                            window.location.href = "${base}/EDU/competition.html"
                        });
                    }else {
                        layer.msg("报名失败");
                        return false;
        ...
        function updloadImg() {
            var formData = new FormData();
            formData.append('imgFile', $('#formUpLoadImg')[0].files[0]?$('#formUpLoadImg')[0].files[0]:"");
            $.ajax({
