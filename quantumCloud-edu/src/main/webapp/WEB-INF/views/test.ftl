...
<div id="LoginContent" class="LoginContent">
    <div class="LoginConLeft">
        ...
        <a class="go_home_login" href="javascript:" onclick="window.parent.location='${base}/EDU/index.html'">返回首页</a>
    </div>
    <div class="LoginConRight">
        ...
        <div class="to_wechat">
            <i></i>
            <a href="javascript:" onclick="loginByWeibo()"><img src="${base}/assets/images/wchatImg.png" alt=""></a>
            <i></i>
            <a href="javascript:" onclick="loginByQQ()"><img src="${base}/assets/images/wchatImg.png" alt=""></a>
        </div>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width: 700px">
            ...
            <div style="display:none;" class="quick-login">
...
<script>
	...
	if(winHeight>600){
		document.getElementById("LoginContent").style.margin="300px auto"
	}
...
//        });
    ...
    function loginByWeibo() {
        parent.location.href = "${weiboLogin!}"
    }

    function loginByQQ() {
        parent.location.href = "${qqLogin!}"
    }
            ...
            if (data.success) {
                ...
                if(forward!=null&&forward!=''){
                    ...
                    if(top.location!=self.location) {
                        ...
                        window.location.href = "${base}/EDU/index.html";
                    }
                }
...
//                errorMsg(data.message);
    ...
    function loginbyweibo() {
        window.location.href = "${base}/authorizationWeiBo.html"
    }
</script>
</html>
