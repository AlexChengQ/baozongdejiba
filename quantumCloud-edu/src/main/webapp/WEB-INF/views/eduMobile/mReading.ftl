        ...
        <div class="contentBox" style="padding: 0">
            ...
            <div class="content">
                ...
                <div class="bannerOrSwiper">
                    <div>
                        <img src="${base}/assets/images/EduImg/jpeg_app_banner.png" alt="" style="width:100%;">
                    </div>
                    <div class="ReadingBox">
                        <div class="chooseRead">
                            <div>
                                <div class="bookSection1 sectionBtn" data-list="1" >
                                    <div class="sectionImg"></div>
                                    <img src="${base}/assets/images/EduImg/icon_app_book2.png" alt="">
                                    <h3>书籍</h3>
                                </div>
                                <div class="bookSection2 sectionBtn" data-list="1" style="display: none  ">
                                    <img src="${base}/assets/images/EduImg/icon_app_book1.png" alt="">
                                    <h3>书籍</h3>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="paperSection1 sectionBtn" data-list="2">
                                    <img src="${base}/assets/images/EduImg/icon_app_paper2.png" alt="">
                                    <h3>论文</h3>
                                </div>
                                <div class="paperSection2 sectionBtn" style="display: none" data-list="2">
                                    <img src="${base}/assets/images/EduImg/icon_app_paper1.png" alt="">
                                    <h3>论文</h3>
                                </div>
                            </div>
                        </div>
                        <div class="Reading-con">
                            <div class="conList">
                                <#--<div class="book-des">-->
                                        <#--<div>-->
                                            <#--<img src="${base}/assets/images/EduImg/icon_app_1.png" alt="">-->
                                            <#--<div class="book-info">-->
                                                <#--<h3>量子计算与量子信息原理</h3>-->
                                ...
                                <#--<div class="book-des">-->
                                    <#--<div>-->
                                        <#--<img src="${base}/assets/images/EduImg/icon_app_2.png" alt="">-->
                                        <#--<div class="book-info">-->
                                ...
                                <#--<div class="book-des">-->
                                        <#--<div>-->
                                            <#--<img src="${base}/assets/images/EduImg/icon_app_3.png" alt="">-->
                                            <#--<div class="book-info">-->
                                                <#--<h3>量子计算和量子信息(一)</h3>-->
                                                <#--<ul class="book-author">-->
                                ...
                                <#--<div class="book-des">-->
                                    <#--<div>-->
                                        <#--<img src="${base}/assets/images/EduImg/icon_app_4.png" alt="">-->
                                        <#--<div class="book-info">-->
                                ...
                                <#--<div class="book-des">-->
                                    <#--<div>-->
                                        <#--<img src="${base}/assets/images/EduImg/icon_app_5.png" alt="">-->
                                        <#--<div class="book-info">-->
                                            <#--<h3>Principles of Quantum Computation and Information</h3>-->
                                ...
                                <#--<div class="book-des">-->
                                    <#--<div>-->
                                        <#--<img src="${base}/assets/images/EduImg/icon_app_6.png" alt="">-->
                                        <#--<div class="book-info">-->
                                            <#--<h3>Principles of Quantum Computation and  Information</h3>-->
                                            <#--<h4 class="twoCol">Volume II: Basic Tools and Special Topics</h4>-->
                                            <#--<ul class="book-author">-->
                                                <#--<li>Giuliano Benenti</li>-->
                                                <#--<li>Giulio Casati</li>-->
                                                <#--<li>Giuliano Strini</li>-->
                                ...
                                <#--<div class="book-des">-->
                                    <#--<div>-->
                                        <#--<img src="${base}/assets/images/EduImg/icon_app_7.png" alt="">-->
                                        <#--<div class="book-info">-->
                                            <#--<h3>QUANTUM COMPUTING</h3>-->
                                            <#--<h4 class="twoCol">From Linear Algebra to Physical Realizations</h4>-->
                                            <#--<ul class="book-author">-->
                            ...
                            <div style="display:none;">
                                <div class="paperBox">
                                    ...
                                    <#--</div>-->
                                    <#--<div class="paperList">-->
                                        <#--<div class="paperList-title">QRunes: High-Level Language for Quantum-Classical Hybrid Programming</div>-->
                                        <#--<p>-->
                                            <#--<span class="buleTitle">Authors: </span>-->
