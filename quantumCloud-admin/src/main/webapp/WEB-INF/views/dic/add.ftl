...
<#escape x as x?html> 
	...
	<ol class="breadcrumb">
		<li></li>
       <li><a href="${base }/Qcode/dic/dicIndex.html">字典管理</a></li>
	...
	<div class="row">
		...
		<input type="hidden" name="id" value="${(dic.id)!}"/>
		 ...
		 <div class="form-group">
			...
			<div class="col-md-6">
			    <input type="text" id="dicName" name="dicName" value="${(dic.dicName)!}" class="form-control"/>
			</div>
		...
		$(".btn-save").click(function(){
			if($("#myFormId").validateForm(saveDicConfig)) {
				$.ajax({  
			        type:'post',  
			        traditional :true,  
			        url:'${base}/Qcode/dic/saveDic.json',
