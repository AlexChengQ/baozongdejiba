...
<@main.body>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post" id="searchForm" action="${base}/qcode/forumtopic/viewModerator.html"
                      autocomplete="off">
                    <input type="hidden" value="${belonged}" id="belonged" name="belonged">
                    <div class="box box-primary">
                        <div class="box-body">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="_email" name="email"
                                               value="${(RequestParameters.email)!}" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="_operDate">注册日期</label>
                                        <input type="hidden" id="registerTime_range_start"
                                               name="registerTime_range_start" type="text"
                                               value="${(RequestParameters.registerTime_range_start)!}" readonly>
                                        <input type="hidden" id="registerTime_range_end" name="registerTime_range_end"
                                               type="text" value="${(RequestParameters.registerTime_range_end)!}"
                                               readonly>
                                        <div class="input-group date registerTime-datetimepicker-day"
                                             data-date="${(RequestParameters.registerTime)!}"
                                             data-date-format="yyyy-mm-dd ">
                                            <input class="form-control" type="text" id="_registerTime"
                                                   name="registerTimeTemp"
                                                   value="${(RequestParameters.registerTimeTemp)!}" readonly>
                            ...
                            <div class="col-md-offset-5 col-md-7">
                                <button class="btn btn-xs btn-primary submitForm">查询</button>&nbsp;&nbsp;&nbsp;
                                <#--<button-->
