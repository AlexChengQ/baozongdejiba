...
<#escape x as x?html> 
	...
	<div class="row">
		...
		<input type="hidden" name="bannerGrade" value="${entity.bannerGrade!1}"/>
		<input type="hidden" name="parentId" value="${entity.parentId!0}"/>
		<input type="hidden" name="bannerPath" value="${entity.bannerPath!''}"/>
		 ...
		 <div class="form-group">
			...
			<div class="col-md-6">
		        <div class="input-group spinner"  data-trigger="spinner">
			        <input type="text" class="form-control text-center" id="bannerIndex" name="bannerIndex" value="${entity.bannerIndex!1}" data-step="1" data-min="1" data-max="2147483647">
		...
		$(".btn-save").click(function(){
			if($("#myFormId").validateForm(saveSysBannerConfig)) {
				$.ajax({  
			        type:'post',  
			        traditional :true,  
			        url:'${base}/SysBanner/update.json',  
