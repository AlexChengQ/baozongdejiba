...
public class JPushUtils {
    ...
    public static PushPayload buildPushObject_android_and_ios(String title,String content,Map<String,String> extras) {
...
//                .setAudience(Audience.registrationId("171976fa8af4bd9d339"))
    ...
    public static void main(String[] args) {
        ...
        map.put("tt","2");
        map.put("dd","3");
        PushPayload payload = buildPushObject_android_and_ios("title","content",map);
