package com.bylz.quantumCloud.admin.service.tag;
...
//        }
        ...
        freeMarkerConfigurer.getConfiguration().setSharedVariable("QcodeUserApplication", staticModels.get(QcodeUserApplication.class.getName())); 
