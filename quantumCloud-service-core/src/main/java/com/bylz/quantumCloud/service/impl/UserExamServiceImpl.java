...
import com.bylz.quantumCloud.service.UserExamService;
 ...
 */
@Component
public class UserExamServiceImpl extends BaseServiceImpl<UserExam, Long> implements UserExamService {

    public String getNamespace() {
        return UserExam.class.getSimpleName();
    }
