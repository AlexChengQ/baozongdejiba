...
<script>
	 $(function () {
		...
		//App.setTopMenu([{name:"保存",icon:"${base}/assets/images/save.png",callback:" ()"}]);
			...
			$.ajax({  
		        ...
		        success:function(data){
		        		if (data.success){
			        		...
			        		var url= "${base}/api/program.html?projectId="+qcodeProjectVersionResult.projectId+"&versionId="+qcodeProjectVersionResult.id;
			        		appViewFinish(url);
