 ...
 * Licensed under the MIT license */
    function (t, e, n, i) {
        ...
        function M(t, e, n) {
            var i = n.pointers.length, a = n.changedPointers.length, r = e & Pt && i - a === 0, o = e & (It | Ht) && i - a === 0;
        ...
        function O(t) {
            for (var e = [], n = 0; n < t.pointers.length;)e[n] = {
                mobileX: mt(t.pointers[n].mobileX),
                mobileY: mt(t.pointers[n].mobileY)
            }, n++;
        ...
        function P(t) {
            var e = t.length;
            if (1 === e)return {x: mt(t[0].mobileX), y: mt(t[0].mobileY)};
            for (var n = 0, i = 0, a = 0; e > a;)n += t[a].mobileX, i += t[a].mobileY, a++;
        ...
        function W(t) {
            for (var e = t.srcEvent.mobileX, n = t.srcEvent.mobileY, i = 0; i < this.lastTouches.length; i++) {
        ...
        var wt = s(function (t, e, n) {
            ...
            return wt(t, e, !0)
        }, "merge", "Use `assign`."), Tt = 1, kt = /mobile|tablet|ip(ad|hone|od)|android/i, xt = "ontouchstart" in t, Ct = T(t, "PointerEvent") !== i, bt = xt && kt.test(navigator.userAgent), Mt = "touch", _t = "pen", Et = "mouse", Dt = "kinect", Ot = 25, Pt = 1, At = 2, It = 4, Ht = 8, St = 1, Yt = 2, Vt = 4, Nt = 8, Ft = 16, qt = Yt | Vt, zt = Nt | Ft, Lt = qt | zt, Rt = ["x", "y"], jt = ["mobileX", "mobileY"];
        C.prototype = {
            handler: function () {
            }, init: function () {
        ...
        var Kt = {pointerdown: Pt, pointermove: At, pointerup: It, pointercancel: Ht, pointerout: Ht}, Ut = {
            2: Mt,
            3: _t,
            4: Et,
            5: Dt
    ...
    t.modal = function (n, i) {
        ...
        var c = t.modal({
            text: '<p class="weui-prompt-text">' + (s.text || "") + '</p><input type="text" class="weui-input weui-prompt-input" id="weui-prompt-input" value="' + (s.input || "") + '" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" />',
            title: s.title,
            autoClose: !1,
            buttons: [{
