...
abstract public class BaseController {
	...
	protected String getMessage(String message, Object... objs)
	{
		return messageSource.getMessage(message, objs, new Locale("zh", "CN"));
	}
	...
	public void handleException(Exception exception, HttpServletRequest request, HttpServletResponse response) {
		...
		if(requestedWith == null || !"XMLHttpRequest".equals(requestedWith)) {
		    ...
		    RequestDispatcher rd =  request.getSession().getServletContext().getRequestDispatcher("/WEB-INF/views/error.ftl"); 
		    try {
