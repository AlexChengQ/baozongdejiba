package com.bylz.quantumCloud.app.server;
...
public class QqsClientServer8012
{
    public static void main(String[] args) throws Exception
    {
        ...
        System.setProperty("stopPort", "8013");
        System.setProperty("listenPort", "8012");
        System.setProperty("contextPath", "/quantumCloud-mobile");
        System.setProperty("docBase", "src/main/webapp");
        System.setProperty("classes.dir", "target/classes");
        System.setProperty("virtualClasspath", "../quantumCloud-service/target/classes;../etc/lib/jars/*.jar");
